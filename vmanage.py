...
#Specify Cisco vManage IP, UN and PW
...
#Login to API Resource and login credentials
...
#Get list of devices that are part of the fabric and display tem
DEVICE_RESOURCE = 'dataservice/device'

#URL for device API resoursce
